package springBootJdbc.sbjdbc.controller;

import java.util.List;
import springBootJdbc.sbjdbc.dao.BankAccountDAO;
import springBootJdbc.sbjdbc.exception.BackTransactionException;
import springBootJdbc.sbjdbc.form.SendMoneyForm;
...
public class MainController {
    ...
    public String processSendMoney(Model model, SendMoneyForm sendMoneyForm) {
        ...
        } catch ( BackTransactionException e) {
